 ...
 */
    ...
    {
        // Récupère toutes les équipes et les envoie à la vue.
 ...
 */
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            // Vérifie si le chef a le niveau d'énergie requis (80) et valide
            ...
            // Validation du chef différents des membres
            ...
            // Validation des membres (2 à 5 membres).
            ...
            // Rendre les super-héros (chef et membres) indisponibles.
            $chef = $equipe->getChef();
            if ($chef) {
 ...
 */
    ...
    public function delete(Request $request, Equipe $equipe, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($this->isCsrfTokenValid('delete'.$equipe->getId(), $request->request->get('_token'))) {
            try {
                // Rendre les membres disponibles si ils ne sont pas dans d'autres équipes.
                foreach ($equipe->getMembres() as $membre) {
